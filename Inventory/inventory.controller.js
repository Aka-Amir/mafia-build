...
var inventory_model_1 = __importDefault(require("./inventory.model"));
var InventoryController = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, inventory_model_1.default.GetInventory(req.body.userId)];
                    case 1:
                        ...
                        if (ModelResponse.Status === status_1.default.PROCCESS_SUCCESS && ModelResponse.Payload) {
                            ...
                            res.status(ModelResponse.Status).send();
                        }
                        return [3, 3];
                    case 2:
                        e_1 = _a.sent();
    ...
    InventoryController = __decorate([
        (0, router_1.RouterModule)("/inventory", [auth_guard_1.DataAuthentication])
    ], InventoryController);
