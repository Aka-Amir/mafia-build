...
var GameSettingController = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ClassicPrice = _a.sent();
                        return [4, game_redis_1.default.GetPrice("Filimo")];
                    case 2:
                        FilimoPrice = _a.sent();
                        return [4, settings_redis_1.default.GetScenarioLimit("Classic")];
                    case 3:
                        ClassicLimit = _a.sent();
                        return [4, settings_redis_1.default.GetScenarioLimit("Filimo")];
                    case 4:
                        FilimoLimit = _a.sent();
                        data = {
                            ClassicPrice: ClassicPrice,
                            FilimoPrice: FilimoPrice,
    ...
    GameSettingController = __decorate([
        (0, router_1.RouterModule)("/game_setting", [auth_guard_1.DataAuthentication])
    ], GameSettingController);
    return GameSettingController;
}());
exports.GameSettingController = GameSettingController;
